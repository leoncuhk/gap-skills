...
Terra is the unified successor to the author's [defog](https://github.com/leoncuhk/defog) (unknowns ledger, quadrants, budgeted asking, quiz gate) and rig (audit-first assembly, strength hierarchy, gated evolution), which remain standalone. It also adapts, with gratitude: Matt Pocock's [skills](https://github.com/mattpocock/skills) (grilling discipline, skill-writing principles) and the documented failure modes of its wayfinder (#450, #484); Thariq Shihipar's map/territory frame; the verification-density principle (Jason Wei's Verifier's Law); plan-conditioned execution (StraTA, arXiv 2605.06642); and trace-driven, regression-gated environment evolution (Self-Harness, arXiv 2606.09498).
